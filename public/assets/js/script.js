...
'<div class="sidebar-layout">' +
	...
	if (window.location.pathname !== '/login' && window.location.pathname !== '/subscription') {
		...
		'<ul class="sticky-sidebar">' +
			...
			'</li>' +
			'<li class="sidebar-icons">' +
				'<a href="/subscription" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
