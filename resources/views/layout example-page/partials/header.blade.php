<!-- Header -->
@if(!Route::is(['example-page.index-one','example-page.index-two','example-page.index-three','example-page.index-four']))
<div class="header">
@endif	
...
@endif	
	<!-- Logo -->
		...
		<a href="{{url('example-page/index')}}" class="logo logo-normal">
			<img src="{{ URL::asset('/assets/img/logo.png')}}"  alt="">
		</a>
		
		<a href="{{url('example-page/index')}}" class="logo logo-white">
			<img src="{{URL::asset('assets/img/logo-white.png')}}"  alt="">
		</a> 
		<a href="{{url('example-page/index')}}" class="logo-small">
		...
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu notifications">
				...
				<div class="noti-content">
					<ul class="notification-list">
						<li class="notification-message">
							<a href="{{url('example-page/activities')}}">
				...
				<div class="topnav-dropdown-footer">
					<a href="{{url('example-page/activities')}}">View all Notifications</a>
				</div>
			</div>
		</li>
		<!-- /Notifications -->
		...
		<li class="nav-item dropdown has-arrow main-drop">
			...
			<div class="dropdown-menu menu-drop-user">
				<div class="profilename">
					...
					<hr class="m-0">
					<a class="dropdown-item" href="{{url('example-page/profile')}}"> <i class="me-2"  data-feather="user"></i> My Profile</a>
					<a class="dropdown-item" href="{{url('example-page/generalsettings')}}"><i class="me-2" data-feather="settings"></i>Settings</a>
					<hr class="m-0">
					<form action="{{ route('logout') }}" method="POST">
						@csrf
						<button type="submit"><a class="dropdown-item logout pb-0"><img src="{{ URL::asset('/assets/img/icons/log-out.svg')}}" class="me-2" alt="img">Logout</a></button>
					</form>
				</div>
			</div>
		</li>
	...
	<div class="dropdown mobile-user-menu">
		...
		<div class="dropdown-menu dropdown-menu-right">
			<a class="dropdown-item" href="{{url('example-page/profile')}}">My Profile</a>
			<a class="dropdown-item" href="{{url('example-page/generalsettings')}}">Settings</a>
			<a class="dropdown-item" href="{{url('example-page/signin')}}">Logout</a>
		</div>
	</div>
	<!-- /Mobile Menu -->
	@if(Route::is(['example-page.index-three']))
