        ...
        <div class="row">
            <div class="col-sm-12">
                <section class="comp-section">
                    <div class="card-body">
                        <form action="{{ isset($data) ? route('owner.produk.merek.update', Crypt::encrypt($data->id)) : route('owner.produk.merek.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @if (isset($data))
                            {{ method_field('PUT') }}
                            @endif
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control @error('name')
                                                is-invalid
                                            @enderror" autofocus value="{{ old('name') ?? ($data->name ?? null) }}" required>
                                        @error('name')
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="image-upload">
                                            <input id="imageUpload" class="@error('image') is-invalid @enderror" name="image" type="file">
