                        ...
                        <table class="table datanew">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="me-3" href="{{ route('owner.produk.merek.edit', ['id' => Crypt::encrypt($brand->id)]) }}">
                                            <img src="{{ URL::asset('assets/img/icons/edit.svg') }}" alt="img" />
                                        </a>
                                        <a class="me-3" id="confirm-delete" data-action="{{ route('owner.produk.merek.delete', ['id' => Crypt::encrypt($brand->id)]) }}">
