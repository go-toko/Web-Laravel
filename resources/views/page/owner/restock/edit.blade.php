                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-groupicon">
                                                <input id="date" name="date" type="text"
                                                    ...
                                                    value="{{ old('date') ?? (isset($data->date) ? Carbon\Carbon::createFromDate($data->date)->format('d-m-Y') : null) }}"
                                                    required>
                                                <div class="addonset">
                                    ...
                                    <div class="col-12" id="dynamicInput">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-sm-6 col-12">
                                                ...
                                                is-invalid
                                            @enderror"
                                                        value="{{ old('quantity[0]') ?? ($data->detail[0]->quantity ?? null) }}">
                                                    @error('quantity[0]')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
