...
<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item my-auto">
            ...
            <span class="badge rouded-pill bg-success" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="{{ Carbon\Carbon::now()->diffInDays(Carbon\Carbon::parse(Auth::user()->subscription->expire)) }} days left">
                Premium
            </span>
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <hr class="m-0">
                    <a class="dropdown-item" href="{{ route('my-profile.index') }}"> <i class="me-2" data-feather="user"></i> My Profile</a>
            ...
            <div class="col-lg-8 col-sm-12 tabs_wrapper">
                ...
                <ul class=" tabs owl-carousel owl-theme owl-product  border-0 ">
                    ...
                    <li id="{{ Str::slug($item->name) }}">
                        <div class="product-details ">
                            <img src="{{ 
                                @if ($item->images && $item->images != 'noimage.png')
                                        $item->images
                                    @else
                                        URL::asset('/images/categories/noimage.png')
                                @endif
                                 }}" alt="img">
                    ...
                    <div class="tab_content active" data-tab="all">
                        <div class="row ">
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill" data-id="{{ $item->id }}" data-name="{{ $item->name }}" data-price="{{ $item->price_sell }}" data-image="{{ URL::asset('/images/products/' . $item->images) }}" data-quantity="{{ $item->quantity }}" onclick="addToCart(event)">
                                    <div class="productsetimg">
                                        <img src="{{ 
                                        @if ($item->images && $item->images != 'noimage.png')
                                        $item->images
                                        @endif
                                            URL::asset('/images/products/noimage.png')
                                         }}" alt="img">
                    ...
                    <div class="tab_content" data-tab="{{ Str::slug($category->name) }}">
                        <div class="row ">
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex ">
                                <div class="productset flex-fill" data-id="{{ $item->id }}" data-name="{{ $item->name }}" data-price="{{ $item->price_sell }}" data-image="{{ URL::asset('/images/products/' . $item->images) }}" data-quantity="{{ $item->quantity }}" onclick="addToCart(event)">
                                    <div class="productsetimg">
                                        <img src="{{ URL::asset('/images/products/' . $item->images) }}" alt="img">
                                        <h6>Qty: {{ $item->quantity }}</h6>
                                        <div class="check-product">
                                            <i class="fa fa-check"></i>
                                        </div>
