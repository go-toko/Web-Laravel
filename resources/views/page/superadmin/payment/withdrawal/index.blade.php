                                    ...
                                    <tbody>
                                        @foreach ($data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('superadmin.payment.shop.show', $value->id) }}"
                                                        class="btn btn-primary btn-sm text-white">Transaksi</a>
                                                </td>
                                                <td> {{ $value->bank }}</td>
                                                <td>
                                                    <div class="dropdown">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        @if ($value->status == 'created')
                                                            <a href="{{ url('superadmin/payment/withdrawal/' . $value->id . '/process') }}"
                                                                class="btn btn-success btn-sm text-white me-2">
                                                                Accept
                                                            </a>
                                                            <a href="{{ url('superadmin/payment/withdrawal/' . $value->id . '/failed') }}"
                                                                class="btn btn-danger btn-sm text-white">
                                                                Reject
                                                            </a>
                                                        @elseif ($value->status == 'process')
                                                            <a href="{{ url('superadmin/payment/withdrawal/' . $value->id . '/success') }}"
                                                                class="btn btn-success btn-sm text-white me-2">
                                                                Confirm
                                                            </a>
                                                            <a href="{{ url('superadmin/payment/withdrawal/' . $value->id . '/failed') }}"
