    ...
    Route::group(['middleware' => ['hasStore']], function () {
        ...
        Route::group(['prefix' => 'penjualan', 'as' => 'penjualan.'], function () {
            ...
            Route::group(['prefix' => 'statistik-penjualan', 'as' => 'statistik-penjualan.'], function () {
                ...
                Route::post('/cashier', [SalesStatisticController::class, 'getCashierOnShop'])->name('cashier');
            });
        ...
        Route::group(['prefix' => 'orang', 'as' => 'orang.'], function () {
            Route::group(['middleware' => ['alreadySelectShop'], 'prefix' => 'kasir', 'as' => 'kasir.'], function () {
                ...
                Route::get('/{username}', [CashierController::class, 'cashierByUsername'])->name('getCashierByUsername');
            });
